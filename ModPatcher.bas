...
Sub downloadPatcher()
    ...
    erro = (comb Is Nothing) ' Se comb for Nothing, significa que o módulo não existe
    On Error GoTo 0
    
    ' Se erro = True, significa que "ModAtualizador1" não existe, então usar "ModAtualizador2"
    If erro = True Then
        numero = 1
